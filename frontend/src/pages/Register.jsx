            ...
            >
              ...
              <div className="space-y-4">
                <h2 className="text-5xl font-black text-gray-900 leading-tight">
                  Grow Your <span className="text-agriGreen">Future</span> With Us
                </h2>
                <p className="text-xl text-gray-600 leading-relaxed">
                  Become part of a thriving community where farmers, buyers, and agricultural experts collaborate for mutual success.
                </p>
              </div>

              <div className="grid grid-cols-2 gap-6">
                {[
                  { icon: Leaf, label: 'Direct Trading', color: 'text-green-600' },
                  { icon: ShoppingBag, label: 'Quality Assured', color: 'text-blue-600' },
                  { icon: CheckCircle2, label: 'Verified Experts', color: 'text-purple-600' },
                  { icon: MapPin, label: 'Real-time GPS', color: 'text-amber-600' }
                ].map((stat, index) => (
                  <motion.div
                    key={index}
                    ...
                    className="flex items-center gap-3 bg-white p-4 rounded-2xl shadow-sm border border-gray-100"
                  >
              ...
              <div className="p-8 bg-agriGreen/10 rounded-[2rem] border border-agriGreen/20">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-3 text-gray-700 font-medium text-sm">
                      <div className="w-1.5 h-1.5 rounded-full bg-agriGreen" />
                      {item}
                    </li>
                  ))}
                </ul>
